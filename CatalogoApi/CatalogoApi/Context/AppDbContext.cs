...
namespace CatalogoApi.Context
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder mb)
        {
            ...
            //Categoria
            mb.Entity<CategoriaModel>().Property(c => c.Nome)
                                       .HasMaxLength(100)
                                       .IsRequired();

            mb.Entity<CategoriaModel>().Property(c => c.Descricao)
                                       .HasMaxLength(150)
                                       .IsRequired();
            ...
            mb.Entity<ProdutoModel>().Property(c => c.Nome)
                                      .HasMaxLength(100)
                                      .IsRequired();

            mb.Entity<ProdutoModel>().Property(c => c.Descricao)
                                      .HasMaxLength(150);

            mb.Entity<ProdutoModel>().Property(c => c.Imagem)
                                      .HasMaxLength(100);

            mb.Entity<ProdutoModel>().Property(c => c.Preco)
                                      .HasPrecision(14,2);
